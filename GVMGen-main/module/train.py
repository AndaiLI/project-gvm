...
from .decoder.utils.cluster import get_slurm_parameters
...
def init_seed_and_system(cfg):
    ...
    import torch
    import random
    from .decoder.modules.transformer import set_efficient_attention_backend
    try:
